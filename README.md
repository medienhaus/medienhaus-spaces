...
You can add custom styles or override existing by adding `enableUserCssOverrides = true` to `config.js` and adding `_userOverrides.css` in `/assets`. This file will be loaded _after_ the default styles.
