...
import { CloseIcon, DeleteBinIcon, MenuAddIcon } from '@remixicons/react/line';
                ...
                { !matrix.serviceSpaces.etherpad ? (
                    ...
                    <>
                        <Header>
                            <h2>{ etherpadPath }</h2>
                            <ToggleButton
                                onClick={() => setDisplayCreatePad(prevState => !prevState)}>
                                <Icon>
                                    { displayCreatePad ? <CloseIcon /> : <MenuAddIcon /> }
                                </Icon>
                            </ToggleButton>
                        </Header>
