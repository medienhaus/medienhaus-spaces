...
function useMatrixProvider(auth) {
    ...
    const [isLookingForApplicationSpace, setIsLookingForApplicationSpace] = useState(false);
    const [isLookingForServiceSpaces, setIsLookingForServiceSpaces] = useState(false);
    /**
    ...
    useEffect(() => {
        ...
        const lookForApplicationsFolder = async () => {
            ...
            setIsLookingForApplicationSpace(true);
            ...
            setIsLookingForApplicationSpace(false);
        };

        initialSyncDone && !applicationsFolder && !isLookingForApplicationSpace && lookForApplicationsFolder();

        return () => {
            cancelled = true;
        };
    }, [applicationsFolder, createRoom, initialSyncDone, isLookingForApplicationSpace, spaces]);
    ...
    useEffect(() => {
        ...
        const lookForServiceSpaces = async () => {
            ...
            setIsLookingForServiceSpaces(true);
            ...
            setIsLookingForServiceSpaces(false);
        };

        applicationsFolder && _.isEmpty(serviceSpaces) && !isLookingForServiceSpaces && lookForServiceSpaces();

        return () => {
            cancelled = true;
        };
    }, [applicationsFolder, authenticationProvider, createRoom, isLookingForServiceSpaces, serviceSpaces, setServiceSpaces, spaces]);
