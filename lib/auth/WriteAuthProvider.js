...
class WriteAuthProvider {
    constructor(configuration) {
        // @TODO @robertschnuell needs comment as to why variable is named defaultPads, or alternatively a different variable name
        this.defaultPads = {};
        this.url = configuration.api;
        this.defaultGroupPrefix = 'myfiles'; //@TODO why myfiles?
    ...
    async syncAllPads() {
        ...
        // @TODO what if no group is found?
