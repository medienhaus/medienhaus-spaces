    ...
    async _createElement(name, parentFolderId = this.homeFolderId, type = 'space') {
        const response = await this.makeRequest(this.url + '/api/spaces', {
            ...
            body: JSON.stringify({
                ...
                access_mode: 'public' //this is nessesary to invite other matrix users.
                // @TODO: add a way to set the access mode for the spacedeck space. Would need a new common functionality to manage invites of auth providers first.
            }),
        });
