...
class MatrixAuthProvider {
    ...
    async createRoom(name, isSpace, topic, joinRule, type, template, application, visibility, historyVisibility, preset) {
        const opts = {
            name: name,
            room_version: '10',
        ...
        await this.matrixClient.sendStateEvent(room.room_id, 'dev.medienhaus.meta', medienhausMetaEvent).catch((e) => {console.debug(e);});
        await new Promise(r => setTimeout(r, 100)); // quick rate limit hack
