...
class MatrixAuthProvider {
    ...
    fetchRoomMessages(roomId, limit = 1) {
        return this.matrixClient.http.authedRequest(undefined, 'GET', `/rooms/${roomId}/messages`, { limit: limit, dir: 'b', filter: JSON.stringify({ types: ['m.room.message'] }) }, {});
    }
