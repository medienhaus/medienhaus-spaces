...
class EtherpadMyPadsAuthProvider {
    constructor(configuration) {
        ...
        this.spacesGroupName = configuration.spacesGroupName || getConfig().publicRuntimeConfig.name;
...
export default EtherpadMyPadsAuthProvider;
