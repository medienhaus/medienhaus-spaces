...
function useAuthProvider() {
    ...
    const getAccessTokensFromAccountData = async (username, password) => {
        ...
        if (dataChanged) {
            // write accessTokensToAccountData. this function is needed to prevent spamming with eventId's, even if the accesstokens are all still valid and doesnt need to be updated.
