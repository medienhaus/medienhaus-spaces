...
function useAuthProvider() {
    ...
    const getActiveAuthenticationProviderNames = useCallback(() => {
        return Object.keys(activeAuthentications);
    }, [activeAuthentications]);
     ...
     */
    const signIntoAllAuthProviders = useCallback(async (username, password) => {
        const accessTokens = {};
    ...
    return {
        ...
        getActiveAuthenticationProviderNames,
